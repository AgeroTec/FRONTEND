...
export function CredorFilters({
  ...
  onKeyDown,
  searchInputRef,
  searchPlaceholder = "Buscar por nome ou documento (busca automatica)",
  searchAriaLabel = "Buscar registros por nome ou documento",
  showConsistencia = false,
}: CredorFiltersProps) {
  return (
    <div className="flex gap-3 mb-6 flex-wrap">
      ...
      <div className="flex-1 relative min-w-[300px]">
        <label htmlFor="search-input" className="sr-only">Buscar registros</label>
        <input
          id="search-input"
          ref={searchInputRef}
          type="text"
      ...
      <select
        ...
        aria-label="Filtrar registros por status"
      >
